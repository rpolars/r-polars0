...
The recommended way to install this package is via R-universe rpolars repository.
...
[The "Install" vignette](https://pola-rs.github.io/r-polars/vignettes/install.html) (`vignette("install", "polars0")`)
...
The [Get Started vignette](https://pola-rs.github.io/r-polars/vignettes/polars.html) (`vignette("polars0")`) provides
